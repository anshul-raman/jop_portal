      ...
      <div class="container">
        <div class="row">
          <div class="col-sm card p-4 m-1">
            ...
            <form
              action="/personalprofile/updatedetails"
              method="post"
            ...
            >
              <fieldset disabled>
                ...
                <input
                  hidden
                  type="text"
                  value="${profile.current_address_fk}"
                  readonly
                  id="current_address_fk"
                  name="current_address_fk"
                />
                <input
                  hidden
                  type="text"
                  value="${profile.permanent_address_fk}"
                  readonly
                  id="permanent_address_fk"
                  name="permanent_address_fk"
                />
          ...
          <div class="col card p-4 m-1">
            ...
            <form
              action="/personalprofile/updateaddress"
              method="post"
              name="address"
            >
              <fieldset disabled>
          ...
          <c:forEach items="${results}" var="r">
            <div class="col-4 card p-2 m-0">
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <select
                          ...
                          id="result_type"
                        >
                          <option value="${r.result_type}" selected>
                            ${r.result_type_details.name}
                          </option>
                      ...
                      <div class="form-group">
                        ...
                        <select
                          ...
                          id="univ_id"
                        >
                          <option value="${r.univ_id}" selected>
                            ${r.university.name}
                          </option>
              ...
              <div class="container">
                <form
                  class="form-inline"
                  action="/personalprofile/deleteResult"
                  method="post"
                >
                  <input
                    type="hidden"
